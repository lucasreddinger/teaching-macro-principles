...
\draw[dashed] (0,5) node[left]{$w^*_\text{2020q1}$} --(5,5) --(5,0) node[below]{$L^*_\text{2020q1}$};
\end{tikzpicture}
\end{center}
\end{solution}
...
\draw[thick,blue] (3,9)--(9,3) node[right]{$D_2$};
\draw[dashed] (0,5) node[left]{$w^*_\text{2020q1}$} --(5,5) --(5,0) node[below]{$L^*_\text{2020q1}$};
\draw[dashed](0,7) node[left]{$w^*_\text{2021q1}$} --(5,7) --(5,0) node[below,yshift=-12pt]{$L^*_\text{2021q1}$};
\end{tikzpicture}
\end{center}
\vspace{-12pt}
\end{solution}
...
\draw[dashed] (0,5) node[left]{$w^*_\text{2020q1}$} --(5,5) --(5,0) node[below,yshift=-10pt]{$L^*_\text{2020q1}$};
\draw[dashed](0,8) node[left]{$w^*_\text{2021q1}$} --(6,8) --(6,0) node[below]{$L^*_\text{2021q1}$};
\end{tikzpicture}
\begin{tikzpicture}[scale=0.4]
\draw[thick,<->] (0,10) node[left]{wage $w$}--(0,0)--(10,0) node[below right]{$L$ (hours)};
\draw[thick,red] (1,1)--(9,9) node[right]{$S$};
...
\draw[thick,blue] (3,9)--(9,3) node[right]{$D_2$};
\draw[dashed] (0,5) node[left]{$w^*_\text{2020q1}$} --(5,5) --(5,0) node[below]{$L^*_\text{2020q1}$};
\draw[dashed](0,8.5) node[left]{$w^*_\text{2021q1}$} --(3.5,8.5) --(3.5,0) node[below,yshift=-10pt]{$L^*_\text{2021q1}$};
\end{tikzpicture}
\vspace{-12pt}
\end{center}
