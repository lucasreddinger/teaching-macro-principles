...
\begin{solution}
\begin{center}
\begin{tikzpicture}[x=2mm,y=10mm,scale=0.27]
...
\draw[very thick,->] (0,0) -- (0,22) node[left,xshift=-1mm,yshift=4mm] {$w$};
\draw[very thick,->] (0,0) -- (220, 0) node[below,xshift=8mm,yshift=-1mm] {$L$ (hours)};
